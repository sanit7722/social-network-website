<%@ page language="C#" masterpagefile="~/MasterPageNew.master" autoeventwireup="true" inherits="personal, App_Web_mabazu3g" title="Friends information" %>
            ...
            <tr>
                <td class="style2">
                    <asp:Label ID="Label1" runat="server" Font-Size="Large" 
                        Text="Friends Information"></asp:Label>
                </td>
                <td>
                    <asp:Image ID="Image4" runat="server" Height="160px" Width="141px" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
